...
## Purpose
This procedure guides senior auditors in performing a comprehensive risk assessment of the AWS environment to identify high-risk areas that require audit attention.
...
### 7. Submit for Review
- Submit completed risk assessment workpaper to audit manager (Maurice)
- Be prepared to discuss findings and risk ratings
- Address any questions or concerns
- Make revisions as needed based on feedback
